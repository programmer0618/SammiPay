...
const FeedbackCard = ({ content, name, title, idx }) => {
  return (
    <div
      className={`flex justify-between flex-col px-10 py-12 cursor-pointer feedback-card rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5`}
    >
      <img
        src={quotes}
        alt="quotes"
      ...
      />
      <p className="font-montserrat text-[18px] leading-[32px] font-normal text-white my-10">
        {content}
      </p>
